package("spdlog")
    ...
    add_versions("2024.5.22", "c3aed4b68373955e1cc94307683d44dca1515d2b")
    ...
    if is_plat("windows") then
        ...
        add_configs("console_wchar",  {description = "Support wchar api.", default = false, type = "boolean"})
    ...
    on_load(function (package)
        ...
        if package:config("console_wchar") then
    ...
    on_install(function (package)
        ...
        table.insert(configs, "-DSPDLOG_UTF8_TO_WCHAR_CONSOLE=" .. (package:config("console_wchar") and "ON" or "OFF"))
